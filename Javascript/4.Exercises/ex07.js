...
function bhaskara(a, b, c) {
    ...
    if(delta <0) {
        ...
        console.log(`As raízes da equação são x' = ${raiz1} e x'' = ${raiz2}`)
        vetor = []
        vetor.push(raiz1)
        vetor.push(raiz2)
        console.log("Resultado em forma de vetor:")
        console.log(vetor)
    }
}
